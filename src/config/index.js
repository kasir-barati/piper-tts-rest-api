 ...
 * @default 'PLAIN_TEXT'
 */
export const LOGGING_MODE = /** @type {import('../utils/logger.js').LogMode} */ (
 ...
 * @default 'info'
 */
export const LOGGING_LEVEL = /** @type {import('../utils/logger.js').LogLevel} */ (
...
export const SERVICE_NAME =
  process.env.SERVICE_NAME ?? "piper-tts-rest-api";
